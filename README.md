...
## Questão 1 - Explique o que é JSON e por que ele se tornou tão popular para troca de dados
entre aplicações.
...
## Questão 2 - Qual a diferença fundamental entre JSON.stringify() e JSON.parse()? Dê um
